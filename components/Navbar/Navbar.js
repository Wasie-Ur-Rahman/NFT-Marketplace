...
//         <div className='h-[4.5rem]  dark:bg-black flex bg-white  lg:w-[1279px] md:w-[1242px]   sm:w-[1242px] xs:w-[1242px] xss:w-[1242px]  xl:w-screen 2xl:w-screen border dark:border-gray-900 border-gray-200  relative   '>
...
//    <button  class=" flex  text-sm mx-12 -my-9 h-[33px] w-[450px] text-gray-600 dark:text-white dark:bg-[#070707] bg-[#ffffff]  rounded-2xl border border-transparent outline-none  placeholder:text-gray-600 dark:placeholder:text-white placeholder:text-start items-center justify-start " onClick={search}  ><p>Search by Collection , NFT or User</p></button>
...
// <button className=" w-20  h-[30px] items-center justify-center bg-transparent dark:text-white text-gray-600 font-secondary text-base hover:font-bold hover:animate-pulse xs:hidden" onClick={home}>Home</button>
// <button className=" w-20  h-[30px] items-center justify-center bg-transparent dark:text-white text-gray-600 font-secondary text-base hover:font-bold hover:animate-pulse xs:hidden" onClick={discover}>Discover</button>

// {open===false ? (
   
//    <button className="  w-28 h-[30px]  dark:bg-gray-900 dark:border-gray-800  border-2 items-center justify-center rounded-xl  dark:text-white  bg-[#000000] text-white border-gray-400 text-sm font-secondary hover:animate-pulse xs:hidden " onClick={routes}>Connect</button>
//   ) :  
...
//       <button  tabIndex={0} className="  w-16   hover:animate-pulse lg:-ml-2 "  onClick={()=>setDrop(!drop)}>
// <svg width="50" height="50" viewBox="0 0 48 48" className='dark:fill-slate-900 fill-gray-600' xmlns="http://www.w3.org/2000/svg"><rect width="75" height="60" className='dark:fill-white fill-gray-600'  fill-opacity="0.01"/><path d="M40 28L24 40L8 28" stroke="#333" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 10H40" stroke="#333" stroke-width="1" stroke-linecap="round"/><path d="M8 18H40" stroke="#333" stroke-width="1" stroke-linecap="round"/></svg>
