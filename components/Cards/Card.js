export const CardUser = ({ image, link, name, Discription, type }) => {
    ...
    return (
        <div className=" shadow-md dark:shadow-gray-800 shadow-gray-400 dark:bg-black bg-gray-200  dark:border-gray-900 border-gray-600 h-[22rem] w-[16rem]  rounded-2xl  border border-opacity-20 ">
            <a href={link} >
