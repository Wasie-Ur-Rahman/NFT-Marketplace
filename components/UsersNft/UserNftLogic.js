...
console.log("Individual Data",data)
    ...
    return (
        ...
        (
        <div className="relative flex flex-col  lg:w-[1279px] md:w-[1242px] xs:h-[2600px] 2xl:h-[2000px]  sm:w-[1242px] xs:w-[1242px] xss:w-[1242px]  xl:w-screen 2xl:w-screen  max-h-fit dark:bg-black bg-white  " >
<Navbar/>
<div className="flex flex-col h-96 lg:w-[1279px] md:w-[1242px]   sm:w-[1242px] xs:w-[1242px] xss:w-[1242px]  xl:w-screen 2xl:w-screen bg-zinc-800">
    <div className="flex flex-row h-full w-full object-cover ">
        <img src="./Back.jpg" className="w-full" />

    </div>
    <div className="flex flex-row h-28 w-full justify-start rounded-full -my-32 ">
        <img src={alph} className="w-32 rounded-full border-2 
    dark:border-gray-600 bg-slate-900 border-gray-600 "/>
    </div>
</div>
<div className="flex flex-col h-24 w-2/4  space-y-4">
<input className=' h-8 w-4/5 ml-5 dark:text-white text-gray-900 bg-transparent font-bold text-xl  ' value={data3} readOnly/> 
     <input className=' h-8 w-full ml-5 bg-transparent text-gray-600 ' value={cookies.user} readOnly/> 
</div>
<div className=" flex flex-wrap h-full w-full  justify-center mt-5 space-x-2 space-y-2" >
...
<div className="flex flex-row h-fit w-full mt-10">
         <Footer/>   
         </div>  
