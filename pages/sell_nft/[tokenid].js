...
//         <div className="flex flex-col h-screen w-screen  lg:w-[1279px] md:w-[1242px]   sm:w-[1242px] xs:w-[1242px] xss:w-[1242px]  xl:w-screen 2xl:w-screen max-h-fit xs:h-[3000px] sm:h-[3000px] md:h-[3000px]  xl:h-[3000px]  lg:h-[3000px]  dark:bg-black bg-white" >
//         <Navbar />
...
//                     <input type='text' onChange={Handle_Price} value={price} className='flex flex-row h-8 dark:text-white text-gray-600 w-2/5 dark:bg-black bg-white outline-none border-gray-200 rounded-md border dark:border-gray-900 pl-2'></input>
                    ...
                    <div className="flex flex-col w-full overflow-x-hidden dark:bg-black bg-white">
                        ...
                        <div className="" >
                            ...
                            <div className="flex flex-col h-auto w-full dark:bg-black  bg-white items-center mt-10" >
                                ...
                                <div class="flex flex-col my-20 xs:w-1/2 xxs:w-full  w-full mx-auto">
                  <div class="-m-1.5 overflow-x-auto">
                    <div class="p-1.5 min-w-full inline-block align-middle">
                      <div class="border rounded-lg overflow-hidden dark:border-gray-900 border-gray-200 shadow-md dark:shadow-gray-900 shadow-gray-600 ">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
