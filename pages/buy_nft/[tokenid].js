...
//   const [cookies2, setCookie] = useCookies(['likesz']);
...
//   //  const folder_data = await firestore.collection('NFTS').doc(`${token.tokenid}`).get();
//   //  console.log("data", folder_data.data())
 
//     if(click===true  && check===1 && like.likes>=0 )
//     {
...
//       const counting = await firestore.collection("NFTS").doc(`${token.tokenid}`).update({
//   likes : ++counter
...
//       setCheck(0)
//       // console.log(`You liked ${counter}`)
//       setCount1(1)
//       console.log("LIKES",counter)
//       setCookie('likesz',count1);
      
//     console.log("cookie result", count1)
//       read()
//       console.log("Like")
//      await firestore.collection("NFTS").doc(`${token.tokenid}`).update({
//         Liked : "Yes"
...
//     else if(check===0 && click===false && like.likes>=0 )
//     {
...

           {
             ...
             (
              ...
              <div className="mt-10 w-full ">
                ...
                <div class="flex flex-col xs:w-1/2 xxs:w-full sm:w-full md:w-full w-3/4 mx-auto">
                  <div class="-m-1.5 overflow-x-auto">
                    <div class="p-1.5 min-w-full inline-block align-middle">
                      <div class="border rounded-lg overflow-hidden dark:border-gray-900 border-gray-200 shadow-md dark:shadow-gray-900 shadow-gray-600 ">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
